...
/*!
 接收到视频流事件的代理
 */
@property (nonatomic, weak) id<RCRTCVideoInputStreamEventDelegate> streamEventDelegate;

/*!
 接收到的视频流代理
 */
@property (nonatomic, weak) id<RCRTCVideoInputStreamDelegate> delegate DEPRECATED_MSG_ATTRIBUTE(
