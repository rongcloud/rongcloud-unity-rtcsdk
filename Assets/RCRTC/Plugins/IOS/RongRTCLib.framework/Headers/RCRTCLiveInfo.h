...
/*!
 ...
 @remarks 资源管理
 */
- (void)enableInnerCDN:(BOOL)enable completion:(void (^)(BOOL isSuccess, RCRTCCode code))completion;
...
/*!
 ...
 @remarks 资源管理
 */
- (void)setMixConfig:(RCRTCMixConfig *)config completion:(void (^)(BOOL isSuccess, RCRTCCode code))completion;
