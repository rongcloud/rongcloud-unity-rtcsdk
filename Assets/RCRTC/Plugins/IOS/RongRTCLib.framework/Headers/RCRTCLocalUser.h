...
- (void)requestJoinOtherRoom:(NSString *)inviteeRoomId
                  ...
                  completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use requestJoinPK:forKey:userId:autoMix:extra:completion: API instead");
...
- (void)responseJoinOtherRoom:(NSString *)inviterRoomId
                      ...
                      autoMix:(BOOL)autoMix
                        extra:(NSString *)extra
                   completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use responseJoinPK:userId:agree:autoMix:extra:completion: API instead");
